...
export async function blogFetch(endpoint, options = {}) {
...
export async function getPosts({ page = 1, limit = 10, category, tag } = {}) {
...
export async function getHighlightsBlogs({ limit = 5, sort = 'mix' } = {}) {
    const q = new URLSearchParams();
