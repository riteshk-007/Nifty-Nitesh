...
import { Clock, User, Calendar, BookOpen, ChevronRight, Search, Filter, Star } from 'lucide-react';
          ...
          {currentPosts.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {currentPosts.map((post, index) => (
                ...
                >
                  <Link href={`/blogs/${post.slug}`} className="group">
                    <article className="bg-bg-card border border-border-primary rounded-xl overflow-hidden hover:border-accent-green transition-all duration-300 transform hover:-translate-y-1 backdrop-blur-sm">
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <div className="absolute top-3 left-3">
                          <span className="bg-bg-primary/90 border border-border-primary text-text-primary px-2 py-1 rounded-lg text-xs font-medium backdrop-blur-sm">
                            {post.category}
                          </span>
                        </div>
                      </div>
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-text-muted">{post.views} views</span>
                        </div>
                      </div>
                    </article>
                  </Link>
