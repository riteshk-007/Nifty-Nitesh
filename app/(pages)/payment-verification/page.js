...
const PaymentVerificationPage = () => {
  ...
  useEffect(() => {
    if (!submissionId || !amount || !name) {
      setUploadError(
        "Missing required payment information. Please return to the enrollment page."
      );
    }
    setIsLoading(false);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Complete your enrollment by making the payment and uploading the
            screenshot
          </p>
        </motion.div>
            ...
            <CardContent className="p-6">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Screenshot verification takes just a few minutes
                  </p>
                </div>
                <div>
                  <div className="w-12 h-12 bg-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-3">
