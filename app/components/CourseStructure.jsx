...
const CourseStructure = ({ showTitle = true, className = "" }) => {
  ...
  const toggleShowAll = () => {
    ...
    // Reset expanded card when toggling view
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
                  {[
                    ...
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-emerald-500/10 to-blue-500/10 border border-emerald-500/20 rounded-2xl p-4 md:p-6 text-center hover:border-emerald-500/40 transition-all duration-300"
                    >
