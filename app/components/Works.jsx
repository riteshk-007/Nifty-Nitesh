...
const Works = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-2 md:gap-4 p-5 bg-gray-200 dark:bg-black/30">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 my-5  md:gap-10 flex-wrap justify-center">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex flex-col mx-4 items-center justify-center gap-2 bg-white dark:bg-black p-2 md:p-5 rounded-lg shadow-md w-60 h-80 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105"
          >
