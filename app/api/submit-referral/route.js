...
// Email configuration
const emailConfig = {
  fromEmail: "codeshorts007@gmail.com",
  smtpHost: "smtp-relay.brevo.com",
  smtpUser: "7a3825001@smtp-brevo.com",
  smtpPassword:
    "xsmtpsib-ef7c1018f5caba7281e2365451def2ae9b14d875e50af1253d84ab0cc4cf99e1-CvE1NVPShFYmn4pg",
};

// Google Sheets configuration
const GOOGLE_SHEETS_ID = "1-UwaFATSvzvBqmMB49SWCJ77QfISCjpvQ_WXcFKtuFw";
...
export async function POST(request) {
  try {
    ...
    let sheet = doc.sheetsByTitle["Sheet3"];
    if (!sheet) {
